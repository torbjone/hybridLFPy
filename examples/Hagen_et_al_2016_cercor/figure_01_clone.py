...
def fig_firing_rates(params, ana_params, T=[800, 1000], fraction=0.05, rasterized=False):
    '''set up plot for introduction'''
    ana_params.set_PLOS_2column_fig_style(ratio=0.5)
...
if __name__ == '__main__':
    ...
    for i, savefolder in enumerate(savefolders):
        ...
        #
        # fig.savefig(os.path.join(savefolder, 'figure_01_evoked_cdm.png'),
        #             dpi=450,
        #             bbox_inches='tight', pad_inches=0)

        plt.close("all")
        fig2 = fig_firing_rates(params, ana_params, T=[875, 950], fraction=1.)

        fig2.savefig(os.path.join(savefolder, 'figure_firing_rates.png'),
                    bbox_inches='tight', pad_inches=0)
