...
spike_output_path = os.path.join(savefolder, 'spiking_output_path')
...
def simulate(total_num_virtual_procs=24):
    ...
    nest.SetStatus(espikes,[{
                       "label": os.path.join(spike_output_path.format(total_num_virtual_procs), label + "-EX"),
                       "withtime": True,
                       "withgid": True,
                       "to_file": True,
                       }])
    ...
    nest.SetStatus(ispikes,[{
                       "label": os.path.join(spike_output_path.format(total_num_virtual_procs), label + "-IN"),
                       "withtime": True,
                       "withgid": True,
                       "to_file": True,}])
