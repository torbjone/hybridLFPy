...
simscripts = ["cellsim16pops_modified_regular_input.py"]#,
              # "cellsim16pops_modified_ac_input.py",
              # "cellsim16pops_default.py",
              # "cellsim16pops_modified_spontan.py"] # list all simulation scripts
